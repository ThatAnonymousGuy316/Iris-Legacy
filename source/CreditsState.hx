...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		final defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Tahir',				'tahir',			'Implementing and maintaining SScript on Psych',                 'https://github.com/TahirKarabekiroglu','A04397'],
			['iFlicky',				'flicky',			'Composer of Psync and Tea Time\nMade the Dialogue Sounds',		 'https://twitter.com/flicky_i',		 '9E29CF'],
			['KadeDev',				'kade',				'Fixed some cool stuff on Chart Editor\nand other PRs',			 'https://twitter.com/kade0912',		 '64A250'],
			['superpowers04',		'superpowers04',	'LUA JIT Fork',													 'https://twitter.com/superpowers04',	 'B957ED'],
			['Nebula the Zorua',	'nebula',			'Original Base for LUA JIT Fork, LUA Reworks',										'https://www.youtube.com/@DankPods',	 '7D40B2'],
		...
		for (i in 0...creditsStuff.length)
		{
			...
			if(isSelectable) {
				...
				if (Paths.image('credits/${creditsStuff[i][1]}') != null)
					iconPath = 'credits/${creditsStuff[i][1]}';

				var icon:AttachedSprite = new AttachedSprite(iconPath);
